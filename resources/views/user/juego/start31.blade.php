...
<div align="center">
    ...
    <div  align="center">
        <video id="mi-video"   autoplay>
            <source src="{{ asset('video/24.mp4') }}" type="video/mp4"  >
        </video>
    </div>
    ...
    <div id="bn"  style= "display:none; align:center "  >
        ...
        <table cellpadding="3" cellspacing="3">
            <tr>
                <td colspan="3" >
                    <a class="myButton btn-block" href="{{route('user.juego.start4',8)}}" align="center" type="button" ><h3>Sopa de pastas, arroz, verduras <br> pechuga de pollo y jugo natural</h3></a></td>
                <td colspan="3" >
                    <h3>&nbsp;</h3></td>
                <td colspan="3" >
                    <a class="myButton btn-block" href="{{route('user.juego.start44',9)}}" align="center" type="button" ><h3>Bandeja paisa y<br>jugo natural</h3></a></td>
                <td colspan="3" >
            </tr>
        </table>
